...
describe('Board', () => {
  ...
  test('Values for all rows are checked to see if they contain 1 to 9 with no repeats', () => {
    expect(board.checkAllRows()).toEqual(true);
  });

  test('Values for all columns are checked to see if they contain 1 to 9 with no repeats', () => {
    expect(board.checkAllCols()).toEqual(true);
  });
